...
DRAW::DRAW()
{
	...
	string level_1 = "FEEEEEEEEEEEEEEFFEEEEEEEEEEEEEEFFEEEEEEEEEEEEEEFFEEEEEEEEEEEEEEFFEEEEEEPEEEEEEEFFEEFFFFFFFFFFEEFFEEPEEEEEEEEPEEFFFFFFEEEEEEFFFFFFEEEEEEEEEEEEEEFEEFFFFFFFFFFEEFFETEEEEEEEEENEEFFFFFFFFFFFFFFFFFF";
	...
	string level_5 = "FEEEGEEGEEEEEEEFFEEFFFFFFFFEFEEFFEEEEEEEPEPEFEEFFEEFEFFFFFFFFEEFFEEFEPEPEEEEEEEFFEEFFFFFFFFEFEEFFEEEEEEEEEPEFEEFFEEFEFFFFFFFFEEFFEEFEEEEEEEEEEEFFEEFFFFFFFFEFEEFFEETEEEEEEEENEEFFFFFFFFFFFFFFFFF";
	...
	string level_7 = "FEEEEEECEEEEEEEFFEEFFFFFFFFFFEEFFEEEEEEFFEEEEEEFFFFFEEFFFFEEFFFFFEEEGEFFFFEGEEEFFEFFFFFFFFFFFFEFFEPEEEFFFFEEEPEFFFFFEEFFFFEEFFFFFEEEPEEFFEEPEEEFFEEFFFFFFFFFFEEFFEETEEEEEEEENEEFFFFFFFFFFFFFFFFF";
	...
	string level_10 = "FEECEEEGGEEEGEEFFEEFFFFFFFFFFEEFFEEEEEEEEEEEEEEFFEFFFFFEEFFFFEEFFEEEEGFEEFGEEEEFFEFFFFFEEFFFFEEFFECEEEEEEEEEECEFFEFFFFFEEFFFFEEFFEFEEPEEEEPEEFEFFEFFFFFEEFFFFEEFFEETEEEEEEEENEEFFFFFFFFFFFFFFFFF";
...
void DRAW::drawLevel()
{
	...
	for (int i = 0; i < 12; i++)
	{
		for (int j = 0; j < 16; j++)
		{
			block_type = levels[level].c_str()[i * 16 + j];
			switch (block_type)
			{
			case 'F':
